    ...
    for(;;){
        ...
        if (operation.equals("1")){
            ...
            if (evals.containsKey(code1))
                ...
                surname = in.nextLine();
                evals.put(code1,new Evaluated(code1,surname,name));
            }   
        }//Add Evaluated
        ...
        // ----------------- Add Question --------------------------
            ...
            if (questions.containsKey(code2))//Not to have a duplicate of the same question
                ...
                if (type.equalsIgnoreCase("Multiple choice")){
                    ...
                    questions.put(code2,new MultipleChoice(code2, description, choices, correctChoices)); 
                    choices=new ArrayList<String>();correctChoices=new ArrayList<Integer>();      
                }//Multiple choice
                    ...
                    questions.put(code2,new OneWord(code2,description,correctAnswer));
                }//One word
                    ...
                    questions.put(code2, new Gaps(code2, description, choices, correctOrder));
                    choices = new ArrayList<String>(); correctOrder = new ArrayList<String>();
                ...
                if (!questions.keySet().contains(code2))
                    ...
                    if (!duplicate){
                        ...
                        if (quest instanceof Gaps){
                            ...
                            answers.add(new AnswerGaps(evals.get(code1), questions.get(code2), choices));
                            choices = new ArrayList<String>();
                        }// Gaps answer
                            ...
                            currentAnswer = in.nextLine();
                            answers.add(new AnswerOneWord(evals.get(code1), questions.get(code2),currentAnswer));
                        }// One word answer
                            ...
                            answers.add(new AnswerMul(evals.get(code1), questions.get(code2),evaluatedChoices));
