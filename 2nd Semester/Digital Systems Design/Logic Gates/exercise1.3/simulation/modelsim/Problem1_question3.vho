...
ARCHITECTURE structure OF Problem1_question3 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst~0_combout\ = (\x3~input_o\ & ((\x4~input_o\))) # (!\x3~input_o\ & (\x1~input_o\))
...
-- Equation(s):
-- \inst~1_combout\ = (\inst~0_combout\ & (\x3~input_o\ $ (((\x2~input_o\) # (!\x5~input_o\))))) # (!\inst~0_combout\ & (!\x5~input_o\))
