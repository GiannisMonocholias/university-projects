...
ARCHITECTURE structure OF Problem1_question2 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \Final_output|output_or_4~0_combout\ : std_logic;
SIGNAL \Final_output|output_or_4~1_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \Final_output|output_or_4~1_combout\,
	devoe => ww_devoe,
	o => \f~output_o\);

-- Location: IOIBUF_X3_Y0_N8
\x5~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
\Final_output|output_or_4~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Final_output|output_or_4~0_combout\ = (\x3~input_o\ & ((\x4~input_o\))) # (!\x3~input_o\ & (\x1~input_o\))
...
PORT MAP (
	...
	datac => \x1~input_o\,
	datad => \x4~input_o\,
	combout => \Final_output|output_or_4~0_combout\);

-- Location: LCCOMB_X2_Y3_N10
\Final_output|output_or_4~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Final_output|output_or_4~1_combout\ = (\Final_output|output_or_4~0_combout\ & (\x3~input_o\ $ (((\x2~input_o\) # (!\x5~input_o\))))) # (!\Final_output|output_or_4~0_combout\ & (!\x5~input_o\))
...
PORT MAP (
	...
	datab => \x3~input_o\,
	datac => \x2~input_o\,
	datad => \Final_output|output_or_4~0_combout\,
	combout => \Final_output|output_or_4~1_combout\);
